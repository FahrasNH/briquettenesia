    ...
    <div className="section-wrap" id="principle">
      ...
      <Row gutter={48} className="row-principles">
        <Col className="gutter-row" xs={24} sm={24} md={24} lg={6}>
          ...
          <p className="decs">
            For us, integrity means we do what we say we are going to do.
            Ultimately we aren’t just building a company, we’re building a
            family. So we uphold the highest standards of honesty in all of our
            actions.
          </p>
        </Col>
        <Col className="gutter-row" xs={24} sm={24} md={24} lg={6}>
          ...
          <p className="decs">
            We take pride in providing high value products and services that we
            stand behind, which ensures customer satisfaction, profitability and
        ...
        <Col className="gutter-row" xs={24} sm={24} md={24} lg={6}>
          ...
          <p className="decs">
            We are committed to being the best we can be. In order to achieve
        ...
        <Col className="gutter-row" xs={24} sm={24} md={24} lg={6}>
          ...
          <p className="decs">
            Indonesia is a potential country. Being the leading in export scale,
            we constantly look to improve our product and service, cultivating
            our knowledge, skill, and attitudes to achieve excellence.
          </p>
        </Col>
      </Row>
    </div>
